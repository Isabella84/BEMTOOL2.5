...
name_ind = "HKE18.IND"        # name of the text file containing the list of all the text files for running XSA
name_tun = "HKE18TUN.dat"     # name of the text file containing survey indices for tuning
catch_fleet = "catture_per_eta_HKE.csv"  # name of the file with catch by year, age and fleet segment to disaggregate the total F
