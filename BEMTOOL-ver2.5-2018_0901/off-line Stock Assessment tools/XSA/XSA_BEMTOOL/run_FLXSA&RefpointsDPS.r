...
name_ind = "DPS18.IND"        # name of the text file containing the list of all the text files for running XSA
name_tun = "DPS18TUN.dat"     # name of the text file containing survey indices for tuning
catch_fleet = "catture_per_eta_DPS.csv"  # name of the file with catch by year, age and fleet segment to disaggregate the total F
