...
plotEstimatedPrice_discard <- function(all_the_years, econind_path, econind_path_quantiles) {
...
prices_toplot <- ECOindicators[as.character(ECOindicators$Variable) == "price.discard" & as.character(ECOindicators$Fleet_segment) == fleets_to_plot[ff] & as.character(ECOindicators$Species) == species_to_plot[ss],1:(ncol(ECOindicators)-1)]
...
prices_toplot_1 <- ECOIndicators_quantiles[as.character(ECOIndicators_quantiles$Variable) == "price.discard" & as.character(ECOIndicators_quantiles$Fleet_segment) == fleets_to_plot[ff] & as.character(ECOIndicators_quantiles$Species) == species_to_plot[ss] & ECOIndicators_quantiles[, ncol(ECOIndicators_quantiles)] == 0.05, 1:(ncol(ECOIndicators_quantiles)-2)]

prices_toplot_2 <- ECOIndicators_quantiles[as.character(ECOIndicators_quantiles$Variable) == "price.discard" & as.character(ECOIndicators_quantiles$Fleet_segment) == fleets_to_plot[ff] & as.character(ECOIndicators_quantiles$Species) == species_to_plot[ss] & ECOIndicators_quantiles[, ncol(ECOIndicators_quantiles)] == 0.25, 1:(ncol(ECOIndicators_quantiles)-2)]

prices_toplot_4 <- ECOIndicators_quantiles[as.character(ECOIndicators_quantiles$Variable) == "price.discard" & as.character(ECOIndicators_quantiles$Fleet_segment) == fleets_to_plot[ff] & as.character(ECOIndicators_quantiles$Species) == species_to_plot[ss] & ECOIndicators_quantiles[, ncol(ECOIndicators_quantiles)] == 0.75, 1:(ncol(ECOIndicators_quantiles)-2)]

prices_toplot_5 <- ECOIndicators_quantiles[as.character(ECOIndicators_quantiles$Variable) == "price.discard" & as.character(ECOIndicators_quantiles$Fleet_segment) == fleets_to_plot[ff] & as.character(ECOIndicators_quantiles$Species) == species_to_plot[ss] & ECOIndicators_quantiles[, ncol(ECOIndicators_quantiles)] == 0.95, 1:(ncol(ECOIndicators_quantiles)-2)]
 ...
 prices_toplot_1$Value <-  as.numeric(as.character(prices_toplot_1$Value))
  ...
  prices_toplot_4$Value[is.na( prices_toplot_4$Value)] <- 0
   ...
   plot_title <- paste("Price discard - ", species_to_plot[ss], " - ", fleets_to_plot[ff] , sep="")

if (!MEY_CALCULATION) {
  plot_path <- paste(casestudy_path, "/",harvest_rule_id,"/Economic indicators/", casestudy_name, " - Price discard ",species_to_plot[ss], " - ", fleets_to_plot[ff] , " ", harvest_rule_id,".jpg", sep="")
   plot_title_sub <- paste( casestudy_name, " ",harvest_rule_id , " [", all_the_years[1], "-", all_the_years[length(all_the_years)],"]", sep="")
  } else {
    plot_path <- paste(casestudy_path, "/MEY calculation/",harvest_rule_id,"/Economic indicators/", casestudy_name, " - Price discard ",species_to_plot[ss], " - ", fleets_to_plot[ff] , " ", harvest_rule_id,".jpg", sep="")
    plot_title_sub <- paste( casestudy_name, " ",harvest_rule_id , " [", all_the_years[1], "-", all_the_years[length(all_the_years)],"]", sep="")
  }
