...
# ------------------------------------------------------------------------------
#
SelectivityAge_F.add_columns <- function(treeview) {
...
#print("Adding column to the model...")   
  SelectivityAge_F.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", SelectivityAge_F.cell_edited, SelectivityAge_F.model)
