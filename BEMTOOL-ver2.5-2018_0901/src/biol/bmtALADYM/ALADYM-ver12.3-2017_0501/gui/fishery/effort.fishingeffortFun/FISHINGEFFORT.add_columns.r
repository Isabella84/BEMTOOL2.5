...
# ------------------------------------------------------------------------------
#
FISHINGEFFORT.add_columns <- function(treeview) {
# print("Adding column to the model...")   
  FISHINGEFFORT.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", FISHINGEFFORT.cell_edited, FISHINGEFFORT.model)
