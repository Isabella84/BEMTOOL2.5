...
# ------------------------------------------------------------------------------
#
FishingMvector_M_overall.add_columns <- function(treeview) {
...
#print("Adding column to the model...")   
  FishingMvector_M_overall.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", FishingMvector_M_overall.cell_edited, FishingMvector_M_overall.model)
