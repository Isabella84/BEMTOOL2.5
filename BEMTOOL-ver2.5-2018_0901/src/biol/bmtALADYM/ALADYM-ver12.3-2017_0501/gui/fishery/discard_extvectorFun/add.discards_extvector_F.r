...
# ------------------------------------------------------------------------------
#
add.discards_extvector_F <- function() {
...
#print("Adding elements to the list...")   
  if (!is.null(fleet.discard_extvector_F)) {
  for (r in 1:nrow(fleet.discard_extvector_F)) {
  FF_temp <- as.list(fleet.discard_extvector_F[r,]) 
