...
# ------------------------------------------------------------------------------
#
discards_extvector_M.add_columns <- function(treeview) {
...
#print("Adding column to the model...")   
  discards_extvector_M.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", discards_extvector_M.cell_edited, discards_extvector_M.model)
