...
# ------------------------------------------------------------------------------
#
discards_extvector_F.add_columns <- function(treeview) {
...
#print("Adding column to the model...")   
  discards_extvector_F.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", discards_extvector_F.cell_edited, discards_extvector_F.model)
