...
# ------------------------------------------------------------------------------
#
lan_obligation.add_columns <- function(treeview) {
# print("Adding column to the model...")   
  lan_obligation.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", lan_obligation.cell_edited, lan_obligation.model)
