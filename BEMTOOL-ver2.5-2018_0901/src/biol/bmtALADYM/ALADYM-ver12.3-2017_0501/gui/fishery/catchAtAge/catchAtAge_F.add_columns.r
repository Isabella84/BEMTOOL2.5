...
# ------------------------------------------------------------------------------
#
catchAtAge_F.add_columns <- function(treeview) {
...
#print("Adding column to the model...")   
  catchAtAge_F.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", catchAtAge_F.cell_edited, catchAtAge_F.model)
