...
# ------------------------------------------------------------------------------
#
escape_survival_extvector_M.add_columns <- function(treeview) {
...
#print("Adding column to the model...")   
  escape_survival_extvector_M.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", escape_survival_extvector_M.cell_edited, escape_survival_extvector_M.model)
