...
# ------------------------------------------------------------------------------
#
escape_survival_extvector_F.add_columns <- function(treeview) {
...
#print("Adding column to the model...")   
  escape_survival_extvector_F.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", escape_survival_extvector_F.cell_edited, escape_survival_extvector_F.model)
