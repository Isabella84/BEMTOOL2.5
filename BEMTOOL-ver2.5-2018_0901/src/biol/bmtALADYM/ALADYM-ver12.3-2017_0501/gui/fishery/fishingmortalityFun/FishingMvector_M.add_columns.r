...
# ------------------------------------------------------------------------------
#
FishingMvector_M.add_columns <- function(treeview) {
...
#print("Adding column to the model...")   
  FishingMvector_M.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", FishingMvector_M.cell_edited, FishingMvector_M.model)
