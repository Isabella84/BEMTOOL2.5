...
# ------------------------------------------------------------------------------
#
FishingMvector_F.add_columns <- function(treeview) {
...
#print("Adding column to the model...")   
  FishingMvector_F.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", FishingMvector_F.cell_edited, FishingMvector_F.model)
