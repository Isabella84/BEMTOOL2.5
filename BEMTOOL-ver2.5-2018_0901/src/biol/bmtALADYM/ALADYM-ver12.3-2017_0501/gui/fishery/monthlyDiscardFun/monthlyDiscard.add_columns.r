...
# ------------------------------------------------------------------------------
#
monthlyDiscard.add_columns <- function(treeview) {
# print("Adding column to the model...")   
  monthlyDiscard.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", monthlyDiscard.cell_edited, monthlyDiscard.model)
