...
# ------------------------------------------------------------------------------
#
selectivities.add_columns <- function(treeview) {
#print("Adding column to the model...")   
  selectivities.model <- treeview$getModel()
  # number column
...
#  gSignalConnect(renderer, "edited",selectivities.cell_edited, selectivities.model)
