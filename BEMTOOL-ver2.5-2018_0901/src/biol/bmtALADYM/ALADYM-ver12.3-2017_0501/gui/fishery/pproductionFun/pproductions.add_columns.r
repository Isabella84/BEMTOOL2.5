...
# ------------------------------------------------------------------------------
#
pproductions.add_columns <- function(treeview) {
# print("Adding column to the model...")   
  pproductions.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", pproductions.cell_edited, pproductions.model)
