...
# ------------------------------------------------------------------------------
#
FishingMvector_F_fore.add_columns <- function(treeview) {
...
#print("Adding column to the model...")   
  FishingMvector_F_fore.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", FishingMvector_F_fore.cell_edited, FishingMvector_F_fore.model)
