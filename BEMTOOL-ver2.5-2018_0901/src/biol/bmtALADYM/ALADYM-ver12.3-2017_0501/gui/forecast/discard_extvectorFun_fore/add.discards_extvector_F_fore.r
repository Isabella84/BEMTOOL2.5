...
# ------------------------------------------------------------------------------
#
add.discards_extvector_F_fore <- function() {
...
#print("Adding elements to the list...")   
  if (!is.null(fleet.discard_extvector_F_fore)) {
  for (r in 1:nrow(fleet.discard_extvector_F_fore)) {
  FF_temp <- as.list(fleet.discard_extvector_F_fore[r,]) 
