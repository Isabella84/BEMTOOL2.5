...
# ------------------------------------------------------------------------------
#
add.discards_extvector_M_fore <- function() {
...
#print("Adding elements to the list...")   
  if (!is.null(fleet.discard_extvector_M_fore)) {
  for (r in 1:nrow(fleet.discard_extvector_M_fore)) {
  FF_temp <- as.list(fleet.discard_extvector_M_fore[r,]) 
