...
# ------------------------------------------------------------------------------
#
load_growth_uncert_Linf_from_file <- function(w) {
...
growth_uncert_Linf_from_file_path <<- dialog$getFilename()
...
wnd <- showMessage("        Loading Linf parameters for uncertainty on growth function...        ")

growth_uncert_Linf_from_file_matrix <<- read.csv(growth_uncert_Linf_from_file_path, sep=";")
...
wnd <- showMessageOK("        Impossible load the table with Linf parameters for uncertainty on growth without setting no. of runs!        ")
} else { 
#------------------------------------------ load the file

#------------------------------------------ load the file
reload_growth_uncert_Linf_from_file_table()
wnd$destroy()   
gtkWidgetSetSensitive(main_window, TRUE)
wnd <- showMessageOK("        Table with Linf parameters for uncertainty on growth loaded!        ")
