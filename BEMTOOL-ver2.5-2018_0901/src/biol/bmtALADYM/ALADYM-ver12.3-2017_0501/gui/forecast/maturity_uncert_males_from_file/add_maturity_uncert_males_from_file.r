...
# ------------------------------------------------------------------------------
#
add_maturity_uncert_males_from_file <- function() {
#print("Adding elements to the list...")   
  if (!is.null(maturity_uncert_males_from_file_matrix)) {
  for (r in 1:nrow(maturity_uncert_males_from_file_matrix)) {
  sr_temp <- as.list(maturity_uncert_males_from_file_matrix[r,]) 
