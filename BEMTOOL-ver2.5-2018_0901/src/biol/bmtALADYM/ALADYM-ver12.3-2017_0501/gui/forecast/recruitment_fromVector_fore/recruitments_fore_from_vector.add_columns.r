...
# ------------------------------------------------------------------------------
#
recruitments_fore_from_vector.add_columns <- function(treeview) {
#print("Adding column to the model...")   
  recruitments_fore_from_vector.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()                            
  gSignalConnect(renderer, "edited", recruitments_fore_from_vector.cell_edited, recruitments_fore_from_vector.model)
