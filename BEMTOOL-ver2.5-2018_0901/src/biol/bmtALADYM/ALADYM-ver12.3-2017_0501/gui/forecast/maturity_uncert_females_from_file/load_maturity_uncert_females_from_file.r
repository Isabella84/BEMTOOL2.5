...
# ------------------------------------------------------------------------------
#
load_maturity_uncert_females_from_file <- function(w) {
...
maturity_uncert_females_from_file_path <<- dialog$getFilename()
...
maturity_uncert_females_from_file_matrix <<- read.csv(maturity_uncert_females_from_file_path, sep=";")
...
wnd <- showMessageOK("        Impossible load the table with females parameters for uncertainty on maturity ogive without setting no. of runs!        ")
} else { 
#------------------------------------------ load the file

#------------------------------------------ load the file
reload_maturity_uncert_females_from_file_table()
wnd$destroy()   
gtkWidgetSetSensitive(main_window, TRUE)
wnd <- showMessageOK("        Table with females parameters for uncertainty on maturity ogive loaded!        ")
