...
# ------------------------------------------------------------------------------
#
add_growth_uncert_k_from_file <- function() {
#print("Adding elements to the list...")   
  if (!is.null(growth_uncert_k_from_file_matrix)) {
  for (r in 1:nrow(growth_uncert_k_from_file_matrix)) {
  sr_temp <- as.list(growth_uncert_k_from_file_matrix[r,]) 
