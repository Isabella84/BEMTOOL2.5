...
# ------------------------------------------------------------------------------
#
SelectivityAge_M_fore.add_columns <- function(treeview) {
...
#print("Adding column to the model...")   
  SelectivityAge_M_fore.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", SelectivityAge_M_fore.cell_edited, SelectivityAge_M_fore.model)
