...
# ------------------------------------------------------------------------------
#
SelectivityAge_F_fore.create_model <- function() {
...
#print("Creating model...")   
  ...
  for (i in 1:length(SelectivityAge_F_fore_list)) {
   ...
   # print(paste("in model:", years[nc]) )
         SelectivityAge_F_fore.model$set(iter, e, as.numeric(SelectivityAge_F_fore_list[[i]][e+1]))
    }
