...
# ------------------------------------------------------------------------------
#
FISHINGEFFORT_fore.add_columns <- function(treeview) {
#print("Adding column to the model...")   
 FISHINGEFFORT_fore.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", FISHINGEFFORT_fore.cell_edited, FISHINGEFFORT_fore.model)
