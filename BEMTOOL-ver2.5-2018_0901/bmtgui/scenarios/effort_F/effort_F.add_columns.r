...
# ------------------------------------------------------------------------------
#
bmt_effort_F.add_columns <- function(treeview) {
# print("Adding column to the model...")   
  bmt_effort_F.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", bmt_effort_F.cell_edited, bmt_effort_F.model)
