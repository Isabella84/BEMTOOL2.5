...
# ------------------------------------------------------------------------------
#
bmt_NUMBER_r4.add_columns <- function(treeview) {
# print("Adding column to the model...")   
  bmt_NUMBER_r4.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", bmt_NUMBER_r4.cell_edited, bmt_NUMBER_r4.model)
