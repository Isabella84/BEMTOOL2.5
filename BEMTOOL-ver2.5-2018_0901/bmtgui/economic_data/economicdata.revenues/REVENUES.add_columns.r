...
# ------------------------------------------------------------------------------
#
bmt_REVENUES.add_columns <- function(treeview) {
# print("Adding column to the model...")   
  bmt_REVENUES.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", bmt_REVENUES.cell_edited, bmt_REVENUES.model)
