...
# ------------------------------------------------------------------------------
#
bmt_price_correction_fact.add_columns <- function(treeview) {
# print("Adding column to the model...")   
  bmt_price_correction_fact.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", bmt_price_correction_fact.cell_edited, bmt_price_correction_fact.model)
