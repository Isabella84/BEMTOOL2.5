...
# ------------------------------------------------------------------------------
#
bmt_price_elast_landing_byfleet.add_columns <- function(treeview) {
# print("Adding column to the model...")   
  bmt_price_elast_landing_byfleet.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", bmt_price_elast_landing_byfleet.cell_edited, bmt_price_elast_landing_byfleet.model)
