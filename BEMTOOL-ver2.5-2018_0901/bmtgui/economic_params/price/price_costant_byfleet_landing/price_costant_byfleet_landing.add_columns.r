...
# ------------------------------------------------------------------------------
#
price_costant_byfleet_landing.add_columns <- function(treeview) {
# print("Adding column to the model...")   
  price_costant_byfleet_landing.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", price_costant_byfleet_landing.cell_edited, price_costant_byfleet_landing.model)
