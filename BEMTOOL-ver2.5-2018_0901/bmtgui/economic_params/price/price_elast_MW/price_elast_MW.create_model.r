...
#print("Creating model...")   
  ...
  for (i in 1:length(bmt_price_elast_MW_list)) {
   ...
   # print(paste("in model:", years[nc]) )
         bmt_price_elast_MW.model$set(iter, e, as.numeric(bmt_price_elast_MW_list[[i]][e+1]))
    }
       bmt_price_elast_MW.model$set(iter, (length(BMT_FLEETSEGMENTS)+1),TRUE)
  } 
  }
  #print("price_elast_MW Model successfully created!")  
}
