...
# ------------------------------------------------------------------------------
#
bmt_price_elast_import.add_columns <- function(treeview) {
# print("Adding column to the model...")   
  bmt_price_elast_import.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", bmt_price_elast_import.cell_edited, bmt_price_elast_import.model)
