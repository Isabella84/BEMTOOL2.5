...
# ------------------------------------------------------------------------------
#
bmt_behav_dyn.add_columns <- function(treeview) {
# print("Adding column to the model...")   
  bmt_behav_dyn.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", bmt_behav_dyn.cell_edited, bmt_behav_dyn.model)
