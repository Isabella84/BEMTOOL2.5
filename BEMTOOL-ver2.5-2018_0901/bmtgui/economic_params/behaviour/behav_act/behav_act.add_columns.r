...
# ------------------------------------------------------------------------------
#
bmt_behav_act.add_columns <- function(treeview) {
# print("Adding column to the model...")   
  bmt_behav_act.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", bmt_behav_act.cell_edited, bmt_behav_act.model)
