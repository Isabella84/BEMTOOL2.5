...
#print("Creating model...")   
  ...
  for (i in 1:length(bmt_behav_progr_list)) {
   ...
   # print(paste("in model:", years[nc]) )
         bmt_behav_progr.model$set(iter, e, as.numeric(bmt_behav_progr_list[[i]][e+1]))
    }
       bmt_behav_progr.model$set(iter, (length(BMT_FLEETSEGMENTS)+1),TRUE)
  } 
  }
  #print("behav_progr Model successfully created!")  
}
