...
# ------------------------------------------------------------------------------
#
bmt_behav_progr.add_columns <- function(treeview) {
# print("Adding column to the model...")   
  bmt_behav_progr.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", bmt_behav_progr.cell_edited, bmt_behav_progr.model)
