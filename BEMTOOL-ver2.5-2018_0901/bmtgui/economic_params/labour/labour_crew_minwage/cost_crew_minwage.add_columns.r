...
# ------------------------------------------------------------------------------
#
bmt_cost_crew_minwage.add_columns <- function(treeview) {
# print("Adding column to the model...")   
  bmt_cost_crew_minwage.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", bmt_cost_crew_minwage.cell_edited, bmt_cost_crew_minwage.model)
