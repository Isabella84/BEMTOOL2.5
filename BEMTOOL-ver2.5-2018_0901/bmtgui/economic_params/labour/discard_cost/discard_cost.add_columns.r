...
# ------------------------------------------------------------------------------
#
bmt_discard_cost.add_columns <- function(treeview) {
# print("Adding column to the model...")   
  bmt_discard_cost.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", bmt_discard_cost.cell_edited, bmt_discard_cost.model)
