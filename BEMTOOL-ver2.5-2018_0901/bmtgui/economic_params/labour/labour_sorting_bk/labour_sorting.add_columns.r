...
# ------------------------------------------------------------------------------
#
bmt_labour_sorting.add_columns <- function(treeview) {
# print("Adding column to the model...")   
  bmt_labour_sorting.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", bmt_labour_sorting.cell_edited, bmt_labour_sorting.model)
