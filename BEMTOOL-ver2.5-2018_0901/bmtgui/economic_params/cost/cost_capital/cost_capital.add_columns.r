...
# ------------------------------------------------------------------------------
#
bmt_cost_capital.add_columns <- function(treeview) {
# print("Adding column to the model...")   
  bmt_cost_capital.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", bmt_cost_capital.cell_edited, bmt_cost_capital.model)
