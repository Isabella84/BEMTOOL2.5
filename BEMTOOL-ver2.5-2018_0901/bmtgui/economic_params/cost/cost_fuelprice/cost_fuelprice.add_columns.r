...
# ------------------------------------------------------------------------------
#
bmt_cost_fuelprice.add_columns <- function(treeview) {
# print("Adding column to the model...")   
  bmt_cost_fuelprice.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", bmt_cost_fuelprice.cell_edited, bmt_cost_fuelprice.model)
