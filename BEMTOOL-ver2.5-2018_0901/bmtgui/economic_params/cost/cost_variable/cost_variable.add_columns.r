...
# ------------------------------------------------------------------------------
#
bmt_cost_variable.add_columns <- function(treeview) {
# print("Adding column to the model...")   
  bmt_cost_variable.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", bmt_cost_variable.cell_edited, bmt_cost_variable.model)
