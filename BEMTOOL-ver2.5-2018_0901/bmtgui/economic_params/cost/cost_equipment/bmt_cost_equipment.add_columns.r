...
# ------------------------------------------------------------------------------
#
bmt_cost_equipment.add_columns <- function(treeview) {
# print("Adding column to the model...")   
  bmt_cost_equipment.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", bmt_cost_equipment.cell_edited, bmt_cost_equipment.model)
