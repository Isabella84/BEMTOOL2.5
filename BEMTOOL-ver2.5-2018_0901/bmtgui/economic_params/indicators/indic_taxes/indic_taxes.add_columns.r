...
# ------------------------------------------------------------------------------
#
bmt_indic_taxes.add_columns <- function(treeview) {
# print("Adding column to the model...")   
  bmt_indic_taxes.model <- treeview$getModel()
  # number column
  ...
  # number column
  renderer <- gtkCellRendererTextNew()
  gSignalConnect(renderer, "edited", bmt_indic_taxes.cell_edited, bmt_indic_taxes.model)
