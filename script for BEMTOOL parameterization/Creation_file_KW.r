# Script to create KW files by month for BMT
...
#KW
KW_data=read.table(paste(path_input,"\\KW.csv",sep=""),sep=";", header=T)
...
write.table(DF_final,paste(getwd(),"\\BMT_INPUT\\KW.csv",sep=""),sep=";",row.names=F)      
