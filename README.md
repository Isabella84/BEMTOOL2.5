...
5. Install the packages in the folder "packages required by BEMTOOL" and then the package ALADYMTools from the zip file in ALADYMtools library and run the script RUNme.r to install or load all the needed libraries;
